...
/***/ (function(module, exports, __webpack_require__) {
	...
	( false ? "undefined" : _typeof(({}))) === "object" ? ({}) : (typeof window === "undefined" ? "undefined" : _typeof(window)) === "object" ? window : (typeof self === "undefined" ? "undefined" : _typeof(self)) === "object" ? self : undefined);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _browserDetect = __webpack_require__(334);
	...
	var _views = __webpack_require__(343);

	var _models = __webpack_require__(351);

	var models = _interopRequireWildcard(_models);

	var _filterCollection = __webpack_require__(339);

	var _filterCollection2 = _interopRequireDefault(_filterCollection);
	...
	var filterCollection = new _filterCollection2.default({
	  models: [gsf, cf, bf, sf, ivf, spf, ef, tf, byf, lrf, xof, mdf, sbf, lpf, shf, blf, ebc, and]
	});

	// Fixed Filters
	new _views.FixedFilterView({ el: '#grayscale', model: gsf }).render();
	new _views.FixedFilterView({ el: '#sepia', model: spf }).render();
	new _views.FixedFilterView({ el: '#invert', model: ivf }).render();
	new _views.FixedFilterView({ el: '#emboss', model: ef }).render();
	new _views.FixedFilterView({ el: '#low-res', model: lrf }).render();
	new _views.FixedFilterView({ el: '#bayer', model: byf }).render();
	new _views.FixedFilterView({ el: '#xor', model: xof }).render();
	new _views.FixedFilterView({ el: '#and', model: and }).render();

	new _views.VariableFilterView({ el: '#saturation', model: sf }).render();
	new _views.VariableFilterView({ el: '#contrast', model: cf }).render();
	new _views.VariableFilterView({ el: '#brightness', model: bf }).render();
	new _views.VariableFilterView({ el: '#threshold', model: tf }).render();
	new _views.VariableFilterView({ el: '#median', model: mdf }).render();

	new _views.ConvolutionFilterView({ el: '#sobel', model: sbf }).render();
	new _views.ConvolutionFilterView({ el: '#laplace', model: lpf }).render();
	new _views.ConvolutionFilterView({ el: '#sharpen', model: shf }).render();
	new _views.ConvolutionFilterView({ el: '#blur', model: blf }).render();
	new _views.ConvolutionFilterView({ el: '#embossC', model: ebc }).render();

	if (_browserDetect2.default.isChrome()) {
	  new _app2.default(filterCollection);
	} else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _filterCollectionView = __webpack_require__(336);

	var _filterCollectionView2 = _interopRequireDefault(_filterCollectionView);

	var _canvasView = __webpack_require__(340);

	var _canvasView2 = _interopRequireDefault(_canvasView);

	var _userMedia = __webpack_require__(342);
	...
	function AppController(filterCollection) {
	  ...
	  this.filtersView = new _filterCollectionView2.default({
	    el: '.filters',
	...
	AppController.prototype = Object.assign({}, AppController.prototype, {
	  initialize: function initialize() {
	    _userMedia2.default.getVideoStream(this.onAfterStreamRequest.bind(this));
	  },

	  onAfterStreamRequest: function onAfterStreamRequest(stream) {
	    if (!stream) {
	    ...
	    this.canvasView = new _canvasView2.default(document.querySelector('canvas'), stream);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _framework = __webpack_require__(337);
	...
	var FilterCollectionView = _framework2.default.View.extend({
	  init: function init(options) {
	    this.activeFilters = new _filterCollection2.default();
	    this.collection.on('model.change.active', this.onFilterToggle.bind(this));
	  },

	  onFilterToggle: function onFilterToggle(evt, newVal, oldVal, model) {
	    if (newVal) {
	  ...
	  process: function process(imageData, done) {
	...
	exports.default = FilterCollectionView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	EventEmitter.prototype = {
	  ...
	  unbind: function unbind(event, fn) {
	    this._events = this._events || {};
	  ...
	  attachTo: function attachTo(destObject) {
	...
	Collection.prototype = Object.assign({}, Collection.prototype, {
	  ...
	  _addModel: function _addModel(model, index) {
	  ...
	  _passModelEvent: function _passModelEvent(eventName, newVal, oldVal, model) {
	    this.trigger(eventName, newVal, oldVal, model);
	  }
	});

	EventEmitter.prototype.attachTo(Collection);
	...
	Model.prototype = Object.assign({}, Model.prototype, {
	  ...
	  _buildAttributes: function _buildAttributes() {
	    ...
	    Object.keys(this.attributes).forEach(function (attr) {
	      _this['__' + attr + '__'] = _this.attributes[attr];
	    });
	  },
	...
	EventEmitter.prototype.attachTo(Model);
	...
	View.prototype = Object.assign({}, View.prototype, {
	  ...
	  _setFromOptions: function _setFromOptions(options) {
	  ...
	  _onEvent: function _onEvent(parent, target, eventName, callback) {
	...
	EventEmitter.prototype.attachTo(View);

	/* Helpers */
	var extend = function extend(proto, staticP) {
	  var parent = this;
	  var child;
	  ...
	  if (proto) {
	    (0, _extend2.default)(child.prototype, proto, staticP);
	  }
...
/***/ (function(module, exports) {
	...
	exports.default = function (destObj) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FilterCollection = _framework2.default.Collection.extend({});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _glitch = __webpack_require__(341);
	...
	CanvasView.prototype.draw = function (imageData) {
	  ...
	  if (this.isGlitch) {
	    _glitch2.default.glitch(this.getDataURL(), function (img) {
...
/***/ (function(module, exports) {
	...
	var CHAR_SETS = [["0", ")", "<", ">", ".", "*", "&", "£", "%", "~", "#", "+", "a", "!", "|", "-"], ["a", "b", "c", "d", "e", "f", "z", "x", "v", "n", "m", "o", "i", "y", "q", "w"]];
	...
	var GlitchService = {
	  glitch: function glitch(dataUrl, callback) {
	    ...
	    for (var _i = 2; _i <= chunkCount; _i++) {
	      ...
	      if (glitchRand % 2 || chunkCount === GLITCH_SIZES.legnth - 1) {
	        //glitch the chunk
	        chunks[_i] = chunks[_i].replace(glitchChars[char1Rand], glitchChars[char2Rand]);
	      }
	    } //End chunk loop
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  getVideoStream: function getVideoStream(callback) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.FilterCollectionView = exports.CanvasView = exports.ConvolutionFilterView = exports.VariableFilterView = exports.FixedFilterView = undefined;

	var _filterView = __webpack_require__(344);

	var _filterView2 = _interopRequireDefault(_filterView);

	var _variableFilter = __webpack_require__(347);

	var _variableFilter2 = _interopRequireDefault(_variableFilter);

	var _convolutionView = __webpack_require__(349);

	var _convolutionView2 = _interopRequireDefault(_convolutionView);
	...
	exports.FixedFilterView = _filterView2.default;
	exports.VariableFilterView = _variableFilter2.default;
	exports.ConvolutionFilterView = _convolutionView2.default;
	exports.CanvasView = _canvasView2.default;
	exports.FilterCollectionView = _filterCollectionView2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fixedFilter = __webpack_require__(345);

	var _fixedFilter2 = _interopRequireDefault(_fixedFilter);

	var _dot = __webpack_require__(346);

	var _dot2 = _interopRequireDefault(_dot);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var FixedFilterView = _framework2.default.View.extend({
	  template: _fixedFilter2.default,
	  events: {
	    '.filter click': 'toggleFilter'
	  },

	  render: function render() {
	    this.el.innerHTML = _dot2.default.compile(this.template)(this.model.data());
	    return this;
	  },
	...
	exports.default = FixedFilterView;

/***/ }),
/* 345 */
/***/ (function(module, exports) {

	module.exports = "<input class=\"filter\" type=\"checkbox\" name=\"filter\" value=\"{{=it.name}}\">{{=it.name}}<br>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _variableFilter = __webpack_require__(348);
	...
	var VariableFilterView = _framework2.default.View.extend({
	  template: _variableFilter2.default,
	  ...
	  changeModelValue: function changeModelValue(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _convolutionFilter = __webpack_require__(350);

	var _convolutionFilter2 = _interopRequireDefault(_convolutionFilter);
	...
	var ConvolverFilterView = _framework2.default.View.extend({
	  template: _convolutionFilter2.default,
	...
	exports.default = ConvolverFilterView;

/***/ }),
/* 350 */
/***/ (function(module, exports) {

	module.exports = "<button class=\"convolver {{=it.active}}\" value='{{=it.name}}'>{{=it.name}}</button></br>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.EmbossConvolver = exports.BlurFilter = exports.SharpenFilter = exports.LaplaceFilter = exports.SobelFilter = exports.MedianFilter = exports.AndFilter = exports.XORFilter = exports.LowResFilter = exports.BayerFilter = exports.ThresholdFilter = exports.EmbossFilter = exports.SepiaFilter = exports.InversionFilter = exports.SaturationFilter = exports.ContrastFilter = exports.BrightnessFilter = exports.GrayscaleFilter = undefined;

	var _grayscaleFilter = __webpack_require__(352);

	var _grayscaleFilter2 = _interopRequireDefault(_grayscaleFilter);

	var _brightnessFilter = __webpack_require__(353);

	var _brightnessFilter2 = _interopRequireDefault(_brightnessFilter);

	var _contrastFilter = __webpack_require__(354);

	var _contrastFilter2 = _interopRequireDefault(_contrastFilter);

	var _saturationFilter = __webpack_require__(355);

	var _saturationFilter2 = _interopRequireDefault(_saturationFilter);

	var _inversionFilter = __webpack_require__(356);

	var _inversionFilter2 = _interopRequireDefault(_inversionFilter);

	var _sepiaFilter = __webpack_require__(357);

	var _sepiaFilter2 = _interopRequireDefault(_sepiaFilter);

	var _embossFilter = __webpack_require__(358);

	var _embossFilter2 = _interopRequireDefault(_embossFilter);

	var _thresholdFilter = __webpack_require__(359);

	var _thresholdFilter2 = _interopRequireDefault(_thresholdFilter);

	var _bayerFilter = __webpack_require__(360);

	var _bayerFilter2 = _interopRequireDefault(_bayerFilter);

	var _lowResFilter = __webpack_require__(361);

	var _lowResFilter2 = _interopRequireDefault(_lowResFilter);

	var _xorFilter = __webpack_require__(362);

	var _xorFilter2 = _interopRequireDefault(_xorFilter);

	var _andFilter = __webpack_require__(363);

	var _andFilter2 = _interopRequireDefault(_andFilter);

	var _medianFilter = __webpack_require__(364);

	var _medianFilter2 = _interopRequireDefault(_medianFilter);

	var _sobel = __webpack_require__(365);

	var _sobel2 = _interopRequireDefault(_sobel);

	var _laplace = __webpack_require__(367);

	var _laplace2 = _interopRequireDefault(_laplace);

	var _sharpen = __webpack_require__(368);

	var _sharpen2 = _interopRequireDefault(_sharpen);

	var _blur = __webpack_require__(369);

	var _blur2 = _interopRequireDefault(_blur);

	var _emboss = __webpack_require__(370);

	var _emboss2 = _interopRequireDefault(_emboss);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.GrayscaleFilter = _grayscaleFilter2.default;
	exports.BrightnessFilter = _brightnessFilter2.default;
	exports.ContrastFilter = _contrastFilter2.default;
	exports.SaturationFilter = _saturationFilter2.default;
	exports.InversionFilter = _inversionFilter2.default;
	exports.SepiaFilter = _sepiaFilter2.default;
	exports.EmbossFilter = _embossFilter2.default;
	exports.ThresholdFilter = _thresholdFilter2.default;
	exports.BayerFilter = _bayerFilter2.default;
	exports.LowResFilter = _lowResFilter2.default;
	exports.XORFilter = _xorFilter2.default;
	exports.AndFilter = _andFilter2.default;
	exports.MedianFilter = _medianFilter2.default;
	exports.SobelFilter = _sobel2.default;
	exports.LaplaceFilter = _laplace2.default;
	exports.SharpenFilter = _sharpen2.default;
	exports.BlurFilter = _blur2.default;
	exports.EmbossConvolver = _emboss2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GrayscaleFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'grayscale',
	    'type': 'filter',
	    'active': false,
	  ...
	  filter: function filter(imageData) {
	...
	exports.default = GrayscaleFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BrightnessFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'brightness',
	    'type': 'filter',
	    'active': false,
	  ...
	  _buildLookup: function _buildLookup(value) {
	    var output;
	  ...
	  _onCurrentValueChange: function _onCurrentValueChange(evtName, newVal) {
	    this._buildLookup(newVal);
	  }
	});

	exports.default = BrightnessFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ContrastFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'contrast',
	    'type': 'filter',
	    'active': false,
	...
	exports.default = ContrastFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SaturationFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'saturation',
	    'type': 'filter',
	    'active': false,
	...
	exports.default = SaturationFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InversionFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'invert',
	    'type': 'filter',
	    'active': false,
	  ...
	  _buildLookup: function _buildLookup() {
	    for (var i = 0; i < 256; i++) {
	      this.lookup[i] = 255 - i;
	    }
	  }
	...
	exports.default = InversionFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SepiaFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'sepia',
	    'type': 'filter',
	    'active': false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EmbossFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'emboss',
	    'type': 'filter',
	    'active': false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ThresholdFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'threshold',
	    'type': 'filter',
	    'active': false,
	...
	exports.default = ThresholdFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BayerFilter = _framework2.default.Model.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LowResFilter = _framework2.default.Model.extend({
	  RGB: [[0, 0, 0], [0, 0, 170], [0, 170, 0], [0, 170, 170], [170, 0, 0], [170, 0, 170], [170, 85, 0], [170, 170, 170], [85.85, 85], [85, 85, 255], [85, 255, 85], [85, 255, 255], [255, 85, 85], [255, 85, 255], [255, 255, 85], [255, 255, 255]],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var XORFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'xor',
	    'type': 'filter',
	    'active': false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AndFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'and',
	    'type': 'filter',
	    'active': false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MedianFilter = _framework2.default.Model.extend({
	  defaults: {
	    'name': 'median',
	    'type': 'filter',
	    'active': false,
	  ...
	  filter: function filter(srcData) {
	    var pixels;
	  ...
	  _comparator: function _comparator(a, b) {
	    return a - b;
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _convolver = __webpack_require__(366);

	var _convolver2 = _interopRequireDefault(_convolver);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var SobelFilter = _convolver2.default.extend({
	  defaults: {
	    name: 'sobel',
	    type: 'convolver',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Convolver = _framework2.default.Model.extend({
	  constructor: _framework2.default.Model,
	  /*
	  ...
	  */
	  convolve: function convolve(pixels, opacity) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Laplace = _convolver2.default.extend({
	  defaults: {
	    name: 'laplace',
	    type: 'convolver',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Sharpen = _convolver2.default.extend({
	  defaults: {
	    name: 'sharpen',
	    type: 'convolver',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Blur = _convolver2.default.extend({
	  defaults: {
	    name: 'blur',
	    type: 'convolver',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Emboss = _convolver2.default.extend({
	  defaults: {
	    name: 'emboss',
	    type: 'convolver',
