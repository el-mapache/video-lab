...
/***/ function(module, exports, __webpack_require__) {
	...
	var _convolution = __webpack_require__(299);

	var _convolution2 = _interopRequireDefault(_convolution);

	var _grayscaleFilter = __webpack_require__(304);

	var _grayscaleFilter2 = _interopRequireDefault(_grayscaleFilter);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	new _grayscaleFilter2.default();

	window.ConvolutionFilterView = _convolution2.default;
	window.GrayscaleFilter = _grayscaleFilter2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _framework = __webpack_require__(300);

	var _framework2 = _interopRequireDefault(_framework);

	var _dot = __webpack_require__(302);
	...
	var ConvolutionFilterView = _framework2.default.View.extend({
	  template: template,
	...
	exports.default = ConvolutionFilterView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_util2.default.extend(Collection.prototype, {
	  init: function init() {},
	  ...
	  add: function add(models) {
	    ...
	    _util2.default.forEach(models, this._addModel.bind(this));
	  ...
	  each: function each(callback) {
	    _util2.default.forEach(this.models, function (model) {
	      callback(model);
	    });
	  },
	...
	VL.Events.prototype.attachTo(Collection);
	...
	_util2.default.extend(Model.prototype, {
	  ...
	  _buildAttributes: function _buildAttributes() {
	    var defaults = _util2.default.extend({}, this.defaults);

	    if (!defaults || (typeof defaults === 'undefined' ? 'undefined' : _typeof(defaults)) !== 'object') {
	      return;
	    }

	    _util2.default.extend(this.attributes, defaults);
	  },

	  // Return a copy of the model's attributes as a javascript object
	  data: function data() {
	    return _util2.default.extend({}, this.attributes);
	  }
	});

	VL.Events.prototype.attachTo(Model);
	...
	_util2.default.extend(View.prototype, {
	  render: function render() {
	    return this;
	  },
	...
	VL.Events.prototype.attachTo(View);
	...
	var extend = function extend(proto, staticP) {
	  ...
	  if (proto) {
	    _util2.default.extend(child.prototype, proto, staticP);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GrayscaleFilter = _framework.Model.extend({
	  defaults: {
	    'name': 'grayscale',
	    'type': 'filter',
	    'active': false,
